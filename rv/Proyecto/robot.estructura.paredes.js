...
this.sensor2.set(new THREE.Vector3(this.position.x+3*Math.cos(this.rotation.z-Math.PI),this.position.y+Math.sin(this.rotation.z),this.position.z),new THREE.Vector3(Math.cos(this.rotation.z-Math.PI/2),Math.sin(this.rotation.z-Math.PI/2),0));
