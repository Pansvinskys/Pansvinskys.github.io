...
this.sensor2.set(new THREE.Vector3(this.position.x+3,this.position.y,this.position.z),new THREE.Vector3(Math.cos(this.rotation.z-Math.PI/2),Math.sin(this.rotation.z-Math.PI/2),0));
this.sensor3.set(new THREE.Vector3(this.position.x-3,this.position.y,this.position.z),new THREE.Vector3(Math.cos(this.rotation.z-Math.PI/2),Math.sin(this.rotation.z-Math.PI/2),0));
...
if(pC==false){
 ...
 if(sC==false){
    if (this.sensor.colision==true)
    this.actuator.commands.push('rotateCCW');
    else if (this.sensor.colision==false&&this.sensor3.colision==false)
    this.actuator.commands.push('goStraight');
    else{
