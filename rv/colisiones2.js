...
pelota=new THREE.Mesh(new THREE.SphereGeometry0(0.5),new THREE.MeshNormalMaterial());
cubo1.position.x=7;
cubo2.position.y=-7;
...
escena.add(cubo1,cubo2,pelota,camara);
...
var camara,pelota,cubo1,cubo2,escena,renderer,raycaster1,raycaster2,step,obstaculo1,obstaculo2;
setup();
loop();
