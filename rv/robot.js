function setup(){
 ...
 wllanta1 = new THREE.WireframeHelper( llanta1, 0x0f0000 );
 wllanta2 = new THREE.WireframeHelper( llanta2, 0x0f0000 );
 wllanta3 = new THREE.WireframeHelper( llanta3, 0x0f0000 );
 wllanta4 = new THREE.WireframeHelper( llanta4, 0x0f0000 );
 wllanta5 = new THREE.WireframeHelper( llanta5, 0x0f0000 );
 wllanta6 = new THREE.WireframeHelper( llanta6, 0x0f0000 );
 escena=new THREE.Scene();
 escena.add(llanta1,wllanta1);
 camara=new THREE.PerspectiveCamera();
 camara.position.z=10;
 camara.rotateOnAxis(new THREE.Vector3(1, 0, 0), degInRad(-10));
